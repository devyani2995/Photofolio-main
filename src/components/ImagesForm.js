...
function ImagesForm({ addImage, newimageDetails, showImagesForm, setShowImagesForm, setNewimageDetails }) {
    ...
    return (
        <form className="images-form">
            <h2>Add an Image</h2>
            <input type="text" ref={titleRef} className="images-title" maxLength={30} placeholder="Title" required/>
            <input type="text" ref={urlRef} className="images-url" placeholder="Image URL" required/>
